...
TWITTER_CONSUMER_KEY = key_config.twitter_key_dict['consumer_key']
TWITTER_CONSUMER_SECRET = key_config.twitter_key_dict['consumer_secret']
TWITTER_USER_KEY = key_config.twitter_key_dict['access_token']
TWITTER_USER_SECRET = key_config.twitter_key_dict['access_token_secret']
...
INSTAGRAM_ACCESS_TOKEN = key_config.instagram_key_dict['token']
INSTAGRAM_USER_ID = key_config.instagram_key_dict['user_id']

INSTAGRAM_OAUTH_ENABLED = True
INSTAGRAM_CLIENT_ID = key_config.instagram_key_dict['client_id']
INSTAGRAM_CLIENT_SECRET = key_config.instagram_key_dict['client_secret']
